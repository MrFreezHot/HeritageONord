...
<html>
	<head>
		...
		<!--<body data-plugin-page-transition>-->
			<body data-plugin-page-transition class="loading-overlay-showing" data-loading-overlay data-plugin-options="{'hideDelay': 500, 'effect': 'cubeProgress'}">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col text-center">
							...
							<!-- <p class="mb-1"><ul class="header-social-icons social-icons me-2">
										<li class="social-icons-facebook"><a href="http://www.facebook.com/" target="_blank" title="Facebook">Nos Artciles</a></li> -->
										<!-- <li class="social-icons-twitter"><a href="http://www.twitter.com/" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
										<li class="social-icons-linkedin"><a href="http://www.linkedin.com/" target="_blank" title="Linkedin"><i class="fab fa-linkedin-in"></i></a></li> -->
									</ul></p>
						</div>
						...
						<div class="col-lg-6">
							<div class="progress-bars mt-4">
								<div class="progress-label text-2">
									<span><strong>Conception:</strong> </span>
								</div>
								...
								<div class="progress mb-3">
									<div class="progress-bar progress-bar-primary" data-appear-progress-animation="5%" data-appear-animation-delay="300">
										<span class="progress-bar-tooltip">5%</span>
									</div>
								</div>
								<div class="progress-label text-2">
									<span><strong>Developement</strong></span>
								</div>
								<div class="progress mb-3">
									<div class="progress-bar progress-bar-primary" data-appear-progress-animation="15%" data-appear-animation-delay="600">
					...
					<div class="row justify-content-center pt-2 pb-4">
						<div class="col-lg-6">
							<h5 class="text-dark">etre au courant quand le site est operationel</h5>

							<div class="alert alert-success d-none" id="newsletterSuccess">
								<strong>Félicitation!</strong> Vous avez ete ajoute.e a notre newsletter
							</div>
							...
							<form id="newsletterForm" action="php/newsletter-subscribe.php" method="get">
								<div class="input-group input-group-lg">
									<input class="form-control h-auto" placeholder="Adresse E-Mail" name="newsletterEmail" id="newsletterEmail" type="email">
									<button type="submit" class="btn btn-primary btn-modern text-1">Enregistrer</button>
								</div>
							</form>	
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row py-5 my-4">
						...
						<div class="col-md-3 mb-4 mb-lg-0">
							...
							<p class="text-8 text-color-light font-weight-bold">+(509) 3792 0026</p>
							<p class="mb-2">International: +1(333) 456-6670</p>
							<ul class="list list-icons list-icons-lg">
								<li class="mb-1"><i class="far fa-dot-circle text-color-primary"></i><p class="m-0">56, rue 13 I-J</p></li>
								<li class="mb-1"><i class="far fa-envelope text-color-primary"></i><p class="m-0"><a href="mailto:mail@example.com">mail@heritageonord.com</a></p></li>
							</ul>
